...
# @patch('bluesky_extract.json')
# @patch('bluesky_extract.logging')
# def test_unsuccessful_extract_text_typeerror(mock_logging, mock_json, caplog):
...
#         "Error extracting text: Simulated json dumps error")
...
# @patch('bluesky_extract.logging')
# def test_unsuccessful_extract_text_attributeerror(mock_logging, mock_format_text, mock_json, caplog):
#     """Parsed = dict, json_data=str, text=str"""
...
# @patch('bluesky_extract.extract_text_from_bytes')
...
# @patch('bluesky_extract.get_or_create')
...
# @patch('bluesky_extract.extract_text_from_bytes')
# @patch('bluesky_extract.get_or_create')
# @patch('bluesky_extract.CAR.from_bytes')
# @patch('bluesky_extract.parse_subscribe_repos_message')
...
#     get_firehose_data(b'message', ['cloud'], csv_writer, csvfile)
